...
if len(sys.argv)<6:
    print('USAGE: (1)< base name> (2)<tetrode number> (3)<TOTAL number of dat files> (4)<TOT CHANS: 64/128> (5)<output dir>')
    exit(1)
...
MAX_SIZE = (5000000000 // (TOT_CHANS * 2)) * TOT_CHANS * 2
...
mdaio.writemda16i(mdao.T, out_dir+'/tet'+str(tet)+'raw.mda') 
